...
import com.adorsys.webank.exception.ErrorResponse;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * Handles OtpProcessingException and returns appropriate HTTP response.
     *
     * @param ex The OtpProcessingException that was thrown
     * @return ResponseEntity with error details and INTERNAL_SERVER_ERROR status
     */
    @ExceptionHandler(OtpProcessingException.class)
    public ResponseEntity<ErrorResponse> handleOtpProcessingException(OtpProcessingException ex) {
